...
# several seeds to build a distribution
SEEDS = [42, 7, 123, 2024, 99, 555, 888, 1000, 314, 271]

# ============================================================
# step 1: confidence interval for the baseline (several seeds)
# ============================================================
...
# 95% confidence interval (assuming a t distribution)
...
# clean model: AUC on each degradation
...
# augmented model (mix of all degradations)
np.random.seed(42)
n_train = len(y_train)
...
if p_value < 0.05:
    ...
    print("  (expected, because there are few comparison points)")
